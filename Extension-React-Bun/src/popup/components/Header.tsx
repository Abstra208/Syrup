        ...
        <>
            <Menubar>
                <MenubarMenu>
                    ...
                    <MenubarContent>
                        <MenubarItem onClick={dialog("about")}>About</MenubarItem>
                        <MenubarSeparator/>
                        <MenubarSub>
                            <MenubarSubTrigger>Share</MenubarSubTrigger>
                            <MenubarSubContent>
                                <MenubarItem onClick={share("link")}>Link</MenubarItem>
                                <MenubarItem onClick={share("email")}>Email</MenubarItem>
                                <MenubarItem onClick={share("discord")}>Discord</MenubarItem>
                            </MenubarSubContent>
                        </MenubarSub>
                        <MenubarSeparator/>
                        <MenubarItem onClick={dialog("settings")}>Settings</MenubarItem>
                    </MenubarContent>
                </MenubarMenu>
                <MenubarMenu>
                    ...
                    <MenubarContent className="mr-4">
                        <MenubarItem onClick={(e) => e.preventDefault()}>
                            <input
                                ...
                                className="w-full px-2 py-1 text-sm bg-white dark:bg-black text-black dark:text-white border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-300"
                        ...
                        <MenubarRadioGroup value={language} onValueChange={setLanguage} className="overflow-y-scroll h-30">
                            <MenubarRadioItem className="language-item" value="en">English</MenubarRadioItem>
                            <MenubarRadioItem className="language-item" value="fr">Français</MenubarRadioItem>
                            <MenubarRadioItem className="language-item" value="de">Deutsch</MenubarRadioItem>
                            <MenubarRadioItem className="language-item" value="es">Español</MenubarRadioItem>
                            <MenubarRadioItem className="language-item" value="it">Italiano</MenubarRadioItem>
                            <MenubarRadioItem className="language-item" value="ja">日本語</MenubarRadioItem>
                        </MenubarRadioGroup>
                    </MenubarContent>
                </MenubarMenu>
            </Menubar>
                ...
                <Menubar>
                    <MenubarMenu>
                        ...
                        <MenubarContent className="mr-4">
                            ...
                            <MenubarItem>Coupons Found: {couponsFound}</MenubarItem>
                        </MenubarContent>
                    </MenubarMenu>
                </Menubar>
            ) : <></> }
                ...
                <DialogContent className="w-80 flex flex-col items-center rounded-lg">
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground">Version 1.6.0</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-lg font-semibold">Principal Developers</h3>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground">Website: https://joinsyrup.com</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-lg font-semibold">License</h3>
                            <p className="text-muted-foreground">GPL-3.0 License</p>
                        </div>
                        <div className="space-y-2">
                            <h3 className="text-lg font-semibold">Copyright</h3>
                            <p className="text-muted-foreground">© 2024-25 Syrup group Inc. All rights reserved.</p>
                        </div>
                    </div>
                </DialogContent>
            </Dialog>
            <Dialog open={openSettings} onOpenChange={setOpenSettings}>
                <DialogContent className="w-80 flex flex-col items-center rounded-lg">
                    ...
                    <div>
                        ...
                        <label htmlFor="show-icon">Show the website's icon</label>
                        <p>Do you want to see the website's icon?</p>
                    </div>
                    <div>
                        <Switch defaultChecked={dummyData} onCheckedChange={updatedummyData} id="dummy-data"/>
                        <label htmlFor="dummy-data">Dummy Data</label>
                        <p>Do you want to see dummy data when the domain is invalid? (Dev) (Restart needed)</p>
                    </div>
                </DialogContent>
            </Dialog>
        </>
